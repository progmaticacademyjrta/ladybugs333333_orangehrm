Feature: Login to Orange HRM in different ways
  ...
  Scenario: Login with empty username and valid password
    ...
    Then the user should NOT be able to login successfully with empty credentials and "Required" error message comes.
  ...
  Scenario: Login with valid username and empty password
    ...
    Then the user should NOT be able to login successfully with another empty credentials and "Required" error message comes.
